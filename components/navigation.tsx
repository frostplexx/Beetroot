...
export default function Navigation() {
    ...
    return (
        <header className="fixed absolute overflow-hidden w-screen flex justify-center pointer-events-auto inline-flex bg-[#0e0e0e]/40 backdrop-blur-3xl border border-white/[0.05] rounded-2xl shadow-[0_8px_40px_-8px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.02),0_0_60px_-20px_rgba(232,65,64,0.12)]">
